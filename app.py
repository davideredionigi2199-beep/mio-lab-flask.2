# 1. Importa i moduli necessari dalla libreria flask
from flask import Flask, render_template, request, url_for, redirect

# 2. Istanzia l'applicazione Flask nella variabile 'app'
app = Flask(__name__)

# (Qui sotto andranno poi le tue rotte/funzioni del laboratorio)
# Sample data
transactions = [
